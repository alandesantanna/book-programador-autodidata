...
def carregar_palavras():
    caminho_arquivo = "/home/alan/Documentos/arquivo.txt"
    try:
        with open(caminho_arquivo, "r") as arquivo:
            conteudo = arquivo.read()
            palavras = [palavra.strip() for palavra in conteudo.split(" ") if palavra.strip()]  
        return palavras
...
palavra = selecionar_palavra(palavras)
